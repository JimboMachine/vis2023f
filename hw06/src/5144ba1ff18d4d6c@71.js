...
function _3(__query,artistver,invalidation){return(
__query(artistver,{from:{table:"artistver"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation,"artistver")
)}
...
function _5(__query,artistpublic,invalidation){return(
__query(artistpublic,{from:{table:"artistpublic"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation,"artistpublic")
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([artistVer.csv
  ...
  main.variable(observer()).define(["__query","artistver","invalidation"], _3);
  main.variable(observer("artistpublic")).define("artistpublic", ["FileAttachment"], _artistpublic);
  main.variable(observer()).define(["__query","artistpublic","invalidation"], _5);
