...
function _data(artist,innerCircleQuestion,outerCircleQuestion,buildHierarchy)
{
  ...
  var combinedAnswers = inner.map((innerAns, index) => innerAns + '-' + outer[index]);
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artist-1@1.csv", {url: new URL("./artist-1@1.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
